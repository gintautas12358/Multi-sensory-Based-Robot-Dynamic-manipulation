...
"""autogenerated by genpy from control_core_msgs/LinearStateTrajectory.msg. Do not edit."""
import codecs
import sys
...
class LinearStateTrajectory(genpy.Message):
  _md5sum = "a31d9d4fed89d56cfc1540ec77d1550c"
  _type = "control_core_msgs/LinearStateTrajectory"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','float64[]','control_core_msgs/LinearState[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LinearStateTrajectory, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = control_core_msgs.msg.LinearState()
        _v5 = val1.position
        _x = _v5
        start = end
        end += 24
