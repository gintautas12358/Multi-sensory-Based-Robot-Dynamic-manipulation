...
int main(int argc, char **argv)
{
  ...
  cc::Vector3 p_vec, t_vec, c_vec, y_vec;
  cc::Rotation3 R = cc::Rotation3::Identity();
  ...
  double dt_eval = 1./100.; //2 * M_PI / (omega * cc::Scalar(100));
  for (size_t i = 0; i < 100; ++i)
  {
    cc::Scalar t = i*dt_eval;
